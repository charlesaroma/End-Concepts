...
const tabData = [
  {
    ...
    image: "https://images.unsplash.com/photo-1510511459019-5dda7724fd87?auto=format&fit=crop&w=400&q=80", // Cyber threat
    content: "Protect your business from evolving cyber threats with advanced threat detection and response solutions."
  },
  {
    label: "Compliance",
    image: "https://images.unsplash.com/photo-1465101178521-c1a9136a3b99?auto=format&fit=crop&w=400&q=80", // Compliance docs
    content: "Ensure your organization meets industry regulations and standards with comprehensive compliance solutions."
  },
  {
    label: "Identity & Access",
    image: "https://images.unsplash.com/photo-1519125323398-675f0ddb6308?auto=format&fit=crop&w=400&q=80", // Identity/lock
    content: "Manage user identities and control access to critical resources with robust identity and access management."
  },
  {
    label: "Data Security",
    image: "https://images.unsplash.com/photo-1515168833906-d2a3b82b302b?auto=format&fit=crop&w=400&q=80", // Data security
